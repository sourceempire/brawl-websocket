...
import dr, { createContext as vn, useState as $t, useEffect as Ve, useContext as mn, useMemo as to } from "react";
...
process.env.NODE_ENV === "production" ? tr.exports = ro() : tr.exports = no();
...
var so = rr, Hr = "abcdefghijklmnopqrstuvwxyz012345", Ge = {
  string: function(e) {
    for (var t = Hr.length, r = so.randomBytes(e), n = [], i = 0; i < e; i++)
...
var ke = yn.exports, ao = function(t, r) {
  ...
  return t !== 0;
}, pr = {}, uo = Object.prototype.hasOwnProperty, co;
function Br(e) {
  try {
...
function fo(e, t) {
  ...
  for (i in e)
    if (uo.call(e, i)) {
      if (n = e[i], !n && (n === null || n === co || isNaN(n)) && (n = ""), i = Xr(i), n = Xr(n), i === null || n === null)
        continue;
      r.push(i + "=" + n);
    }
...
pr.stringify = fo;
pr.parse = lo;
var En = ao, Ft = pr, ho = /^[\x00-\x20\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]+/, wn = /[\n\r\t]/g, po = /^[A-Za-z][A-Za-z0-9+-.]*:\/\//, _n = /:\d+$/, vo = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\\/]+)?([\S\s]*)/i, mo = /^[a-zA-Z]:/;
function vr(e) {
  return (e || "").toString().replace(ho, "");
}
var nr = [
  ["#", "hash"],
...
function Cn(e) {
  ...
  if (e.protocol === "blob:")
    ...
    for (a in e)
      a in Jr || (n[a] = e[a]);
    n.slashes === void 0 && (n.slashes = po.test(e.href));
  }
  return n;
}
function ve(e) {
...
function Sn(e, t) {
  ...
  var r = vo.exec(e), n = r[1] ? r[1].toLowerCase() : "", i = !!r[2], a = !!r[3], u = 0, c;
...
function be(e, t, r) {
  ...
  for (l !== "object" && l !== "string" && (r = t, t = null), r && typeof r != "function" && (r = Ft.parse), t = Cn(t), i = Sn(e || "", t), n = !i.protocol && !i.slashes, s.slashes = i.slashes || n && t.slashes, s.protocol = i.protocol || t.protocol || "", e = i.rest, (i.protocol === "file:" && (i.slashesCount !== 2 || mo.test(e)) || !i.slashes && (i.protocol || i.slashesCount < 2 || !ve(s.protocol))) && (w[3] = [/(.*)/, "pathname"]); b < w.length; b++) {
  ...
  r && (s.query = r(s.query)), n && t.slashes && s.pathname.charAt(0) !== "/" && (s.pathname !== "" || t.pathname !== "") && (s.pathname = bo(s.pathname, t.pathname)), s.pathname.charAt(0) !== "/" && ve(s.protocol) && (s.pathname = "/" + s.pathname), En(s.port, s.protocol) || (s.host = s.hostname, s.port = ""), s.username = s.password = "", s.auth && (c = s.auth.indexOf(":"), ~c ? (s.username = s.auth.slice(0, c), s.username = encodeURIComponent(decodeURIComponent(s.username)), s.password = s.auth.slice(c + 1), s.password = encodeURIComponent(decodeURIComponent(s.password))) : s.username = encodeURIComponent(decodeURIComponent(s.auth)), s.auth = s.password ? s.username + ":" + s.password : s.username), s.origin = s.protocol !== "file:" && ve(s.protocol) && s.host ? s.protocol + "//" + s.host : "null", s.href = s.toString();
}
function go(e, t, r) {
  var n = this;
  switch (e) {
...
be.prototype = { set: go, toString: yo };
...
function wo() {
  ...
  Gr = 1;
  function e(t) {
    n.debug = n, n.default = n, n.coerce = w, n.disable = c, n.enable = u, n.enabled = f, n.humanize = Eo(), Object.keys(t).forEach(function(l) {
      n[l] = t[l];
...
var So = or.exports, Rn = ke, xo = oe, Oo = $, jn = V.EventEmitter, kn = So, pe = function() {
};
...
function xe(e, t, r) {
  ...
  var n = this, i = xo.addPath(e, "/websocket");
...
xe.roundTrips = 2;
var To = xe, Ro = $, $n = V.EventEmitter, me = function() {
};
...
var jo = Ae, ko = $, Fn = V.EventEmitter, Je = function() {
};
...
var $o = It, Fo = $, No = oe, mr = jo, Po = $o, it = function() {
};
process.env.NODE_ENV !== "production" && (it = W()("sockjs-client:sender-receiver"));
function br(e, t, r, n, i) {
  var a = No.addPath(e, t);
  it(a);
  var u = this;
  mr.call(this, e, r), this.poll = new Po(n, a, i), this.poll.on("message", function(c) {
...
var Nn = br, Io = $, Ao = oe, Pn = Nn, jt = function() {
};
...
function Lo(e) {
  return function(t, r, n) {
    ...
    var a = Ao.addPath(t, "/xhr_send"), u = new e("POST", a, r, i);
...
function In(e, t, r, n) {
  Pn.call(this, e, t, Lo(n), r, n);
}
Io(In, Pn);
var Ye = In, Do = $, An = V.EventEmitter, Ce = function() {
};
...
var At = lt, Ln = V.EventEmitter, Uo = $, Dn = ke, Mo = oe, at = v.XMLHttpRequest, K = function() {
};
...
ge.prototype._start = function(e, t, r, n) {
  ...
  t = Mo.addQuery(t, "t=" + +/* @__PURE__ */ new Date()), this.unloadRef = Dn.unloadAdd(function() {
...
}, Ho = $, qn = Ye, Bo = At, sr = Lt, Xo = ft, Jo = ht;
function ze(e) {
  if (!Xo.enabled && !sr.enabled)
    throw new Error("Transport created when disabled");
  qn.call(this, e, "/xhr_streaming", Bo, sr);
}
Ho(ze, qn);
ze.enabled = function(e) {
  return e.nullOrigin || Jo.isOpera() ? !1 : sr.enabled;
};
ze.transportName = "xhr-streaming";
ze.roundTrips = 2;
ze.needBody = !!v.document;
var Vo = ze, Wn = V.EventEmitter, Go = $, Hn = ke, Yo = ht, zo = oe, _e = function() {
};
...
Le.prototype._start = function(e, t, r) {
  ...
  t = zo.addQuery(t, "t=" + +/* @__PURE__ */ new Date()), i.onerror = function() {
    _e("onerror"), n._error();
...
Le.enabled = !!(v.XDomainRequest && Yo.hasDomain());
var wr = Le, Ko = $, Bn = Ye, Qo = At, ar = wr;
function dt(e) {
  if (!ar.enabled)
    throw new Error("Transport created when disabled");
  Bn.call(this, e, "/xhr_streaming", Qo, ar);
}
Ko(dt, Bn);
...
dt.roundTrips = 2;
var Xn = dt, Jn = v.EventSource, Zo = $, Vn = V.EventEmitter, es = Jn, Pe = function() {
};
...
var ts = pt, rs = $, Gn = Ye, ns = ts, is = Lt, os = Jn;
function Ke(e) {
  if (!Ke.enabled())
    throw new Error("Transport created when disabled");
  Gn.call(this, e, "/eventsource", ns, is);
}
rs(Ke, Gn);
Ke.enabled = function() {
  return !!os;
...
var vt = zn.exports, ss = $, Kn = V.EventEmitter, as = Yn(), ur = oe, Qn = vt, Zn = ke, us = Ge, ae = function() {
};
...
function ye(e, t, r) {
  ...
  Kn.call(this);
  var n = this;
  this.origin = ur.getOrigin(r), this.baseUrl = r, this.transUrl = t, this.transport = e, this.windowId = us.string(8);
...
}, cs = $, xt = ei, ls = _r, Yt = function(e) {
  function t(r, n) {
    xt.call(this, e.transportName, r, n);
  }
  return cs(t, xt), t.enabled = function(r, n) {
    if (!v.document)
      return !1;
    var i = ls.extend({}, n);
...
}, fs = $, Ne = vt, hs = oe, ti = V.EventEmitter, ds = Ge, de = function() {
};
process.env.NODE_ENV !== "production" && (de = W()("sockjs-client:receiver:htmlfile"));
function ue(e) {
  de(e), ti.call(this);
  var t = this;
  Ne.polluteGlobalNamespace(), this.id = "a" + ds.string(6), e = hs.addQuery(e, "c=" + decodeURIComponent(Ne.WPrefix + "." + this.id)), de("using htmlfile", ue.htmlfileEnabled);
...
var ps = ue, vs = $, cr = ps, ms = ft, ri = Ye;
function mt(e) {
  if (!cr.enabled)
    throw new Error("Transport created when disabled");
  ri.call(this, e, "/htmlfile", cr, ms);
}
vs(mt, ri);
...
mt.roundTrips = 2;
var tn = mt, bs = $, ni = Ye, gs = At, lr = Lt, ii = ft;
function bt(e) {
  if (!ii.enabled && !lr.enabled)
    throw new Error("Transport created when disabled");
  ni.call(this, e, "/xhr", gs, lr);
}
bs(bt, ni);
...
bt.roundTrips = 2;
var rn = bt, ys = $, oi = Ye, Es = Xn, ws = At, nn = wr;
function gt(e) {
  if (!nn.enabled)
    throw new Error("Transport created when disabled");
  oi.call(this, e, "/xhr", ws, nn);
}
ys(gt, oi);
gt.enabled = Es.enabled;
gt.transportName = "xdr-polling";
gt.roundTrips = 2;
var _s = gt, ot = vt, si = Ge, Cs = ht, Ss = oe, xs = $, ai = V.EventEmitter, ne = function() {
};
...
function ie(e) {
  ...
  var r = Ss.addQuery(e, "c=" + encodeURIComponent(ot.WPrefix + "." + this.id));
...
var Os = ie, Ts = Ge, on = oe, he = function() {
};
...
var Ps = De, Is = [
  ...
  Yt(rn),
  Ps
], ut = Array.prototype, Cr = Object.prototype, As = Function.prototype, ct = String.prototype, zt = ut.slice, Sr = Cr.toString, ci = function(e) {
...
yt(Array, { isArray: Ls });
var sn = Object("a"), hi = sn[0] !== "a" || !(0 in sn), qs = function(t) {
  var r = !0, n = !0;
...
var Ws = Array.prototype.indexOf && [0, 1].indexOf(1, 2) !== -1;
yt(ut, {
  indexOf: function(t) {
    ...
    if (!n)
      return -1;
    var i = 0;
    for (arguments.length > 1 && (i = Us(arguments[1])), i = i >= 0 ? i : Math.max(0, n + i); i < n; i++)
      if (i in r && r[i] === t)
        return i;
    return -1;
  }
...
var Hs = ct.substr, Bs = "".substr && "0b".substr(-1) !== "b";
yt(ct, {
  substr: function(t, r) {
    return Hs.call(
      this,
...
var Ot = /[\x00-\x1f\ud800-\udfff\ufffe\uffff\u0300-\u0333\u033d-\u0346\u034a-\u034c\u0350-\u0352\u0357-\u0358\u035c-\u0362\u0374\u037e\u0387\u0591-\u05af\u05c4\u0610-\u0617\u0653-\u0654\u0657-\u065b\u065d-\u065e\u06df-\u06e2\u06eb-\u06ec\u0730\u0732-\u0733\u0735-\u0736\u073a\u073d\u073f-\u0741\u0743\u0745\u0747\u07eb-\u07f1\u0951\u0958-\u095f\u09dc-\u09dd\u09df\u0a33\u0a36\u0a59-\u0a5b\u0a5e\u0b5c-\u0b5d\u0e38-\u0e39\u0f43\u0f4d\u0f52\u0f57\u0f5c\u0f69\u0f72-\u0f76\u0f78\u0f80-\u0f83\u0f93\u0f9d\u0fa2\u0fa7\u0fac\u0fb9\u1939-\u193a\u1a17\u1b6b\u1cda-\u1cdb\u1dc0-\u1dcf\u1dfc\u1dfe\u1f71\u1f73\u1f75\u1f77\u1f79\u1f7b\u1f7d\u1fbb\u1fbe\u1fc9\u1fcb\u1fd3\u1fdb\u1fe3\u1feb\u1fee-\u1fef\u1ff9\u1ffb\u1ffd\u2000-\u2001\u20d0-\u20d1\u20d4-\u20d7\u20e7-\u20e9\u2126\u212a-\u212b\u2329-\u232a\u2adc\u302b-\u302c\uaab2-\uaab3\uf900-\ufa0d\ufa10\ufa12\ufa15-\ufa1e\ufa20\ufa22\ufa25-\ufa26\ufa2a-\ufa2d\ufa30-\ufa6d\ufa70-\ufad9\ufb1d\ufb1f\ufb2a-\ufb36\ufb38-\ufb3c\ufb3e\ufb40-\ufb41\ufb43-\ufb44\ufb46-\ufb4e\ufff0-\uffff]/g, Qt, Xs = function(e) {
  var t, r = {}, n = [];
  for (t = 0; t < 65536; t++)
  ...
  quote: function(e) {
    ...
    return Ot.lastIndex = 0, Ot.test(t) ? (Qt || (Qt = Xs(Ot)), t.replace(Ot, function(r) {
      return Qt[r];
    })) : t;
  }
}, tt = function() {
...
Ks(bi, mi);
var Qs = bi, gi = V.EventEmitter, Zs = $;
function Et() {
  var e = this;
...
Et.timeout = 2e3;
var ea = Et, yi = V.EventEmitter, ta = $, ra = _r, Ei = function() {
};
...
var wi = Or, na = $, _i = V.EventEmitter, ia = ft, oa = wi;
function Dt(e) {
  var t = this;
  _i.call(this), this.ir = new oa(e, ia), this.ir.once("finish", function(r, n) {
...
var Ci = Dt, Si = V.EventEmitter, sa = $, aa = ke, xi = ei, ua = Ci, Oi = function() {
};
...
function Ut(e, t) {
  ...
  Si.call(this);
  var n = function() {
    var i = r.ifr = new xi(ua.transportName, t, e);
...
var ca = Ut, Ti = V.EventEmitter, la = $, fa = oe, un = wr, cn = Lt, ha = ft, da = ea, ln = ca, Tt = wi, Ie = function() {
};
...
Se._getReceiver = function(e, t, r) {
  return r.sameOrigin ? new Tt(t, ha) : cn.enabled ? new Tt(t, cn) : un.enabled && r.sameScheme ? new Tt(t, un) : ln.enabled() ? new ln(e, t) : new Tt(t, da);
};
...
function ma() {
  if (hn)
    return er;
  hn = 1;
  var e = oe, t = ke, r = va(), n = Ci, i = vt, a = di, u = function() {
  };
...
var ba = xn, ga = $, dn = Ge, ya = Js, rt = oe, Ea = ke, wa = Vs, _a = _r, Ca = ht, Sa = Gs, Tr = xr, Ri = Tn, Rt = di, xa = zs, pn = Qs, Oa = pa, q = function() {
};
...
function j(e, t, r) {
  ...
  Ri.call(this), this.readyState = j.CONNECTING, this.extensions = "", this.protocol = "", r = r || {}, r.protocols_whitelist && Sa.warn("'protocols_whitelist' is DEPRECATED. Use 'transports' instead."), this._transportsWhitelist = r.transports, this._transportOptions = r.transportOptions || {}, this._timeout = r.timeout || 0;
  var n = r.sessionId || 8;
...
j.prototype._receiveInfo = function(e, t) {
  ...
  this._rto = this.countRTO(t), this._transUrl = e.base_url ? e.base_url : this.url, e = _a.extend(e, this._urlInfo), q("info", e);
...
j.prototype._connect = function() {
  for (var e = this._transports.shift(); e; e = this._transports.shift()) {
    if (q("attempt", e.transportName), e.needBody && (!v.document.body || typeof v.document.readyState < "u" && v.document.readyState !== "complete" && v.document.readyState !== "interactive")) {
      q("waiting for body"), this._transports.unshift(e), Ea.attachEvent("load", this._connect.bind(this));
      return;
    }
...
var Ta = function(e) {
  return ji = wa(e), ma()(j, e), j;
}, Ra = Is, ja = Ta(Ra);
"_sockjs_onload" in v && setTimeout(v._sockjs_onload, 1);
const ka = /* @__PURE__ */ bn(ja);
class $a {
  constructor(t, r) {
    I(this, "socket");
    I(this, "createSocket", async (t, r) => {
      const n = `${t}/api/events`, i = await oo(`${n}/request`);
      this.socket = new ka(n), this.socket.onerror = this.handleError, this.socket.onclose = this.handleClose, this.socket.onopen = () => this.handleOpen(i.token, r);
    });
...
class Na {
  constructor(t) {
    ...
    I(this, "handleMessage", (t) => {
      const r = JSON.parse(t.data);
      r.event && this.dispatchEvent(r.event, r.message);
    });
    I(this, "unsubscribe", (t, r) => () => {
...
const Pa = () => (console.warn("EventSubscribe used outside of its Provider"), () => {
  console.warn("Unsubscribe called outside of EventSubscribe Provider");
}), $i = vn(Pa);
function Ia({ children: e, socket: t }) {
  const [r, n] = $t(null);
  return Ve(() => (n(new Na(t)), () => r == null ? void 0 : r.cleanup()), [t]), r ? /* @__PURE__ */ nt.jsx($i.Provider, { value: r.subscribe, children: e }) : null;
}
function Aa() {
  return mn($i);
}
const La = () => (console.warn("FeedSubscribe used outside of its Provider"), () => {
  console.warn("Unsubscribe called outside of FeedSubscribe Provider");
}), Fi = vn(La);
function Da({ children: e, socket: t }) {
  const [r, n] = $t(null);
  return Ve(() => (n(new Fa(t)), () => r == null ? void 0 : r.cleanup()), [t]), r ? /* @__PURE__ */ nt.jsx(Fi.Provider, { value: r.subscribe, children: e }) : null;
}
function Ua() {
  return mn(Fi);
}
function Wa({ serverUrl: e, children: t }) {
  const [r, n] = $t();
  return Ve(() => new $a(e, (a) => {
    n(a);
  }).closeConnection, [e]), r ? /* @__PURE__ */ nt.jsx(Da, { socket: r, children: /* @__PURE__ */ nt.jsx(Ia, { socket: r, children: t }) }) : /* @__PURE__ */ nt.jsx("div", { children: "Setting up connection..." });
}
function Ha(e, t) {
  const r = Ua(), [n, i] = $t({ loading: !0 }), a = to(() => t != null && t.queryParams ? `?${Object.keys(t.queryParams).map((c) => `${c}=${t.queryParams[c]}`).join("&")}` : "", [t == null ? void 0 : t.queryParams]);
  return Ve(() => r(`${e}${a}`, (c) => {
    i({ data: c, loading: !1 });
  }), [e, r, a]), Ve(() => {
    !n.loading && !n.data && console.error(
...
export {
  Wa as ServerSubscriptionProvider,
  Ba as useEvent,
  Ha as useFeed
};
